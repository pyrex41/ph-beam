defmodule CollabCanvas.ColorPalettes.PaletteColor do
  ...
  @derive {Jason.Encoder, only: [:id, :palette_id, :color_hex, :position, :inserted_at, :updated_at]}
  ...
  def changeset(palette_color, attrs) do
    ...
    |> validate_format(:color_hex, ~r/^#[0-9A-Fa-f]{6}$/, message: "must be a valid hex color code (e.g., #FF0000)")
